...
@Database(entities = [Category::class, Comment::class, Course::class, Document::class, News::class, Period::class, Score::class, Video::class, AnnualRank::class, TopSchool::class, TopStudent::class], version = 3, exportSchema = false)
