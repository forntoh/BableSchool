package ga.forntoh.bableschool.utilities.exoplayer
...
import ga.forntoh.bableschool.internal.exo.MyTimeBar
...
class PlayerHolder(private val context: Context, private val playerView: PlayerView, private val playerState: PlayerState, progressBar: ProgressBar) {
    ...
    init {
        ...
        this.exo_progress = this.playerView.findViewById(R.id.exo_progress)
        this.parent = this.playerView.parent as ViewGroup
        this.playerView.player = player

        exo_progress.clipAllParents()
    ...
    fun openFullScreenDialog() {
        ...
        exo_progress.animate().translationY(6.inPx.toFloat())
    }
    ...
    fun closeFullScreenDialog() {
        ...
        exo_progress.animate().translationY(12.inPx.toFloat())
    }
